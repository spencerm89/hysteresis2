...
if (any(show %in% c("b.x","b.y"))) segments(a$values["cx","Estimate"],a$values["cy","Estimate"],a$values["cx","Estimate"]+a$values["b.x","Estimate"],a$values["cy","Estimate"]+a$values["b.y","Estimate"],col="blue")
  if (any(show %in% c("focus.x","focus.y"))) points(c(a$values["cx","Estimate"]+a$values["focus.x","Estimate"],a$values["cx","Estimate"]-a$values["focus.x","Estimate"]),c(a$values["cy","Estimate"]+a$values["focus.y","Estimate"],a$values["cy","Estimate"]-a$values["focus.y","Estimate"]),col="gold",size=2)
